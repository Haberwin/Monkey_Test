...
public class SMTPAppender extends AppenderSkeleton implements UnrecognizedElementHandler {
    ...
    /* renamed from: cb */
    protected CyclicBuffer f13cb;
    /* renamed from: cc */
    private String f14cc;
    ...
    /* renamed from: to */
    private String f15to;

    /* renamed from: org.apache.log4j.net.SMTPAppender$1 */
    class C00611 extends Authenticator {
        private final SMTPAppender this$0;

        C00611(SMTPAppender sMTPAppender) {
    ...
    public SMTPAppender(TriggeringEventEvaluator evaluator) {
        ...
        this.f13cb = new CyclicBuffer(this.bufferSize);
    ...
    /* Access modifiers changed, original: protected */
    public void addressMessage(Message msg) throws MessagingException {
        if (this.from != null) {
        ...
        if (this.f15to != null && this.f15to.length() > 0) {
            msg.setRecipients(RecipientType.TO, parseAddress(this.f15to));
        }
        if (this.f14cc != null && this.f14cc.length() > 0) {
            msg.setRecipients(RecipientType.CC, parseAddress(this.f14cc));
        }
    ...
    public synchronized void close() {
        this.closed = true;
        if (this.sendOnClose && this.f13cb.length() > 0) {
            sendBuffer();
        }
    }
    ...
    public String formatBody() {
        ...
        int len = this.f13cb.length();
        for (int i = 0; i < len; i++) {
            LoggingEvent event = this.f13cb.get();
