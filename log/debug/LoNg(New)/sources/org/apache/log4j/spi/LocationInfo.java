...
public class LocationInfo implements Serializable {
    /* renamed from: NA */
    public static final String f19NA = "?";
    public static final LocationInfo NA_LOCATION_INFO = new LocationInfo(f19NA, f19NA, f19NA, f19NA);
    ...
    /* renamed from: pw */
    private static PrintWriter f20pw = new PrintWriter(f21sw);
    static final long serialVersionUID = -1325822038990805636L;
    /* renamed from: sw */
    private static StringWriter f21sw = new StringWriter();
    ...
    public LocationInfo(Throwable t, String fqnOfCallingClass) {
        if (t != null && fqnOfCallingClass != null) {
            ...
            synchronized (f21sw) {
                t.printStackTrace(f20pw);
                s = f21sw.toString();
                f21sw.getBuffer().setLength(0);
            }
