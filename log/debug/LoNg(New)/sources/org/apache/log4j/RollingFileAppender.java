...
public class RollingFileAppender extends FileAppender {
    ...
    public void rollOver() {
        if (this.f1qw != null) {
            long size = ((CountingQuietWriter) this.f1qw).getCount();
    ...
    public synchronized void setFile(String fileName, boolean append, boolean bufferedIO, int bufferSize) throws IOException {
        ...
        if (append) {
            ((CountingQuietWriter) this.f1qw).setCount(new File(fileName).length());
        }
    }
    ...
    public void setQWForFiles(Writer writer) {
        this.f1qw = new CountingQuietWriter(writer, this.errorHandler);
    }

    /* Access modifiers changed, original: protected */
    public void subAppend(LoggingEvent event) {
        super.subAppend(event);
        if (this.fileName != null && this.f1qw != null) {
            long size = ((CountingQuietWriter) this.f1qw).getCount();
