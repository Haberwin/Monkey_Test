<< /system/vendor/data/misc/ProjectConfig.mk >>:
...
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw imx258_mipi_raw ov7251_mipi_raw
CUSTOM_HAL_LENS = dw9714af bu6424af ak7371af dummy_lens
...
CUSTOM_HAL_SUB_IMGSENSOR = ov7251_mipi_raw
...
#CUSTOM_KERNEL_BAROMETER = n     //cheng,133114, 20180518 remove feature for cts
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw imx258_mipi_raw ov7251_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af bu6424af ak7371af dummy_lens
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov7251_mipi_raw
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
# modify by Ryan for cts, adjuts resolution from 1080p to 720p
LCM_HEIGHT = 1280
LCM_WIDTH = 720
LIGHT_NVRAM_DAEMON = no
LINUX_KERNEL_VERSION = kernel-4.4
LOVELYFONTS_ICON_SHOW = no
#[149862] modify by Ryan, Google BTS throught this APK is harmful
...
#[140702] disable audio fuction to fix skype/wechat issue
...
#[141978] Mod by heuan for Factory mode language
...
#Redmine115923 remove FMRadio by yucaiyun
MTK_FM_SUPPORT = no
...
#[119333] Mod by Ryan for BT problem
...
#Redmine116922 modify for only support single sim card
...
#Redmine 113739 ycy add for stresstest 2017-12-06
SAGEREAL_STRESSTEST_APP = no 
#[113565] add by Ryan for DL customized recovery
DL_SYSTEM_UPDATE = yes 
#Redmine 108620 add GMS
BUILD_GMS ?= yes
$(warning BUILD_GMS=$(BUILD_GMS))

#[151256]add by chengqian for russia gms
BUILD_RUSSIA_GMS ?= no
$(warning BUILD_RUSSIA_GMS=$(BUILD_RUSSIA_GMS))

#ethan: add by ethan for RestOfWorld
BUILD_ROW_GMS ?= no
$(warning BUILD_ROW_GMS=$(BUILD_ROW_GMS))

#ethan: add by ethan for EuropeanEconomicArea
BUILD_EEA_GMS ?= no
$(warning BUILD_EEA_GMS=$(BUILD_EEA_GMS))

#build for health care(white)
BUILD_HC ?= no
$(warning BUILD_HC=$(BUILD_HC))

#build for FFHE
BUILD_FFHE ?= no
$(warning BUILD_FFHE=$(BUILD_FFHE))

#build for health care(white)
DL_PROVISION_APP ?= yes
$(warning DL_PROVISION_APP=$(DL_PROVISION_APP))

#ethan: check OPTIONS
ifeq ($(strip $(BUILD_EU_GMS)),yes)
      $(error BUILD_EU_GMS is not support anymore, please use BUILD_EEA_GMS or BUILD_ROW_GMS instead)
endif

ifeq ($(strip $(BUILD_GMS)),yes)
  ifneq ($(filter $(words $(filter yes,$(BUILD_RUSSIA_GMS) $(BUILD_EEA_GMS) $(BUILD_ROW_GMS))),2 3),)
      $(error BUILD_RUSSIA_GMS, BUILD_EEA_GMS, BUILD_ROW_GMS cannot be set together)
  endif
endif
...
#[136528] add by ligaoyuan for fc dialog can show setting begin
FC_DIALOG = no
#[136528] add by ligaoyuan for fc dialog can show setting end
#for UPS BID
#BUILD_UPS_BID = yes
...
#mmc3630x，hehai
COMPASS_MMC3630X_DRV = yes
#Redmine[113740]add by chenzhicheng for factorydeveloptest 2018-01-04
DL_FACTORYDEVELOP = yes 
MTK_EXCHANGE_SUPPORT = yes
CUSTOM_KERNEL_RGBW_SENSOR = no
MTK_MPE_SUPPORT = no
#[121584] add by Ryan for systemupdate and recovery Test
DL_SYSTEM_UPDATE_TEST = no
#[125170] add by Ryan for DL_BAP_API
DL_BSP_API = yes
#[144510] add by chengqian for oem unlock
OEM_UNLOCK_NEED_PASSWORD = yes
...
#add for 3c certification
CCC_CERTIFICATION_OPEN = yes
MTK_HL7005_SUPPORT = no
MTK_DYNAMIC_SBP_LEVEL = 1
#RCM ECC
DL_RCM_CERTIFICATION = yes
#[148998],liucheng,20180928,merge platfrom patch to fix STS failed
MTK_OMADM_SUPPORT = no

ifneq ($(strip $(BUILD_GMS)),yes)
MTK_PROJECTCONFIG_OVERRIDE=\
        DL_RCM_CERTIFICATION=no\
        MTK_CTA_SUPPORT=yes\
        MTK_WAPI_SUPPORT=yes
endif
$(warning MTK_PROJECTCONFIG_OVERRIDE=$(MTK_PROJECTCONFIG_OVERRIDE))
$(foreach x,$(MTK_PROJECTCONFIG_OVERRIDE),$(warning $(x)))
include device/mediatek/build/core/override_config.mk
================ END of FILE ===============
