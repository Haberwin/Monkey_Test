...
public class CyclicBuffer {
    ...
    public CyclicBuffer(int maxSize) throws IllegalArgumentException {
        ...
        this.f7ea = new LoggingEvent[maxSize];
        this.first = 0;
        this.last = 0;
        this.numElems = 0;
    }
    ...
    public LoggingEvent get(int i) {
        ...
        return this.f7ea[(this.first + i) % this.maxSize];
    }
    ...
    public LoggingEvent get() {
        ...
        if (this.numElems > 0) {
            this.numElems--;
            r = this.f7ea[this.first];
            this.f7ea[this.first] = null;
            int i = this.first + 1;
            this.first = i;
            if (i == this.maxSize) {
                this.first = 0;
