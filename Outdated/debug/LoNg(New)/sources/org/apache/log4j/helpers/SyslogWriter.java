...
public class SyslogWriter extends Writer {
    ...
    public void write(String string) throws IOException {
        if (this.f10ds != null && this.address != null) {
            byte[] bytes = string.getBytes();
            int bytesLength = bytes.length;
            if (bytesLength >= 1024) {
                bytesLength = 1024;
            }
            this.f10ds.send(new DatagramPacket(bytes, bytesLength, this.address, this.port));
        }
    }
