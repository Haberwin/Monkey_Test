...
class MyTableModel extends AbstractTableModel {
    ...
    private static final Comparator MY_COMP = new C00121();
    ...
    /* renamed from: org.apache.log4j.chainsaw.MyTableModel$1 */
    final class C00121 implements Comparator {
        C00121() {
        }
    ...
    private class Processor implements Runnable {
        ...
        Processor(MyTableModel x0, C00121 x1) {
            this(x0);
        }
