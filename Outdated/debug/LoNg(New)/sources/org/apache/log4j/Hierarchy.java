...
public class Hierarchy implements LoggerRepository, RendererSupport, ThrowableRendererSupport {
    ...
    public Logger exists(String name) {
        Object o = this.f4ht.get(new CategoryKey(name));
    ...
    public Logger getLogger(String name, LoggerFactory factory) {
        ...
        synchronized (this.f4ht) {
            Object o = this.f4ht.get(key);
            Logger logger;
            if (o == null) {
                logger = factory.makeNewLoggerInstance(name);
                logger.setHierarchy(this);
                this.f4ht.put(key, logger);
    ...
    public Enumeration getCurrentLoggers() {
        Vector v = new Vector(this.f4ht.size());
        Enumeration elems = this.f4ht.elements();
    ...
    private final void updateParents(Logger cat) {
        ...
        for (int i = name.lastIndexOf(46, name.length() - 1); i >= 0; i = name.lastIndexOf(46, i - 1)) {
            ...
            Object o = this.f4ht.get(key);
            if (o == null) {
                this.f4ht.put(key, new ProvisionNode(cat));
