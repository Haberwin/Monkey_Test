...
/*     */   {
/* 254 */     java.util.Collections.sort(list, new Comparator<DeviceFileDetail>() {
...
/*     */   
/*     */ 
/* 266 */   static final SimpleDateFormat shellDateFormatter = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss");
/*     */   
/*     */   static long getDeviceTime(String sn) {
/* 269 */     ArrayList<String> command = new ArrayList();
/* 270 */     command.add("shell");
/* 271 */     command.add("date");
/* 272 */     command.add("+%Y-%m-%d_%H:%M:%S");
