...
#add by hehai redmine id:142875
BOOT_LOGO = wvga
#add by hehai redmine id:142875
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
...
#modify by hehai for AF OTP driver redmine id: 160817 ,20190112
CUSTOM_HAL_CAM_CAL = dummy_eeprom
#modify by hehai for AF OTP driver redmine id: 160817 ,20190112
CUSTOM_HAL_COMBO = mt6739
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_HAL_IMGSENSOR = s5k4h7_mipi_raw n5600_yuv imx386_mipi_raw
CUSTOM_HAL_LENS = dw9714af lc898212xdaf bu6424af ak7371af dummy_lens
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_HAL_MAIN_IMGSENSOR = s5k4h7_mipi_raw
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
...
#modify by hehai for adding scanner driver redmine id :149497 ,2018.10.13
CUSTOM_HAL_SUB_IMGSENSOR = n5600_yuv
#modify by hehai for adding scanner driver redmine id :149497 ,2018.10.13
...
#mod by hehuan for remove redundant items redmineID 161847 2019-1-10
...
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_KERNEL_IMGSENSOR = s5k4h7_mipi_raw n5600_yuv imx386_mipi_raw
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_KERNEL_LENS = dw9714af lc898212xdaf bu6424af ak7371af dummy_lens
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
#mod by hehuan for remove redundant items redmineID 161847 2019-1-10
...
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k4h7_mipi_raw
#modify by hehai for adding camera driver redmine id :149502 ,2018.10.12
...
#modify by hehai for adding scanner driver redmine id :149497 ,2018.10.13
CUSTOM_KERNEL_SUB_IMGSENSOR = n5600_yuv
#modify by hehai for adding scanner driver redmine id :149497 ,2018.10.13
...
#add by hehai for screen flip over 180°　redmine id:149502　　===begin 
MTK_LCM_PHYSICAL_ROTATION = 0
#add by hehai for screen flip over 180°　redmine id:149502　　===end
MTK_LIVEWALLPAPER_APP = yes
MTK_LOG2SERVER_APP = no
MTK_LOG2SERVER_INTERNAL = no
#[150080] Mod by Ryan enable mtklog on user version
...
#Redmine 150616 modified by cms for set single SIM card , 20181019 start
MTK_MULTI_SIM_SUPPORT = ss
#Redmine 150616 modified by cms for set single SIM card , 20181019 end
...
#modify by Ryan for nxp nfc,20181016 begin
#MTK_NFC_PACKAGE =
#MTK_NFC_SE_NUM = 7
#modify for nxp nfc,20181016 end
MTK_NFC_SUPPORT = no
MTK_NLP_SUPPORT = yes
...
#yewei,add charge ic 24296 driver code,redmine-149574
MTK_BQ24296_SUPPORT = yes
#MTK update
MTK_DYNAMIC_SBP_LEVEL = 1
MTK_OMADM_SUPPORT = no

#[163500][Add aged test app]huangzhangbin 20180121
MAIDU_AGED_TEST_SUPPORT = no================ END of FILE ===============
