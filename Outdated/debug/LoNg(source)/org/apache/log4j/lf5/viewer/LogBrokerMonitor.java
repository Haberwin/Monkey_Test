...
/*      */       public void run() {
/*  260 */         LogBrokerMonitor.this._categoryExplorerTree.getExplorerModel().addLogRecord(lr);
...
/*      */       public String toString() {
/*  664 */         return "Maximum number of displayed LogRecords: " + model._maxNumberOfLogRecords;
/*      */       }
/*      */     });
/*      */   }
/*      */   
...
/*      */       public void actionPerformed(ActionEvent e) {
/*  817 */         LogBrokerMonitor.this.showLogLevelColorChangeDialog(result, logLevel);
/*      */       }
/*      */       
/*  820 */     });
/*  821 */     return result;
...
/*      */     LogFactor5ErrorDialog error;
/* 1565 */     try { LogFileParser lfp = new LogFileParser(file);
/* 1566 */       lfp.parse(this);
/* 1567 */       ok = true;
/*      */     } catch (IOException e) {
...
/*      */     LogFactor5ErrorDialog error;
/* 1582 */     try { LogFileParser lfp = new LogFileParser(url.openStream());
/* 1583 */       lfp.parse(this);
/* 1584 */       ok = true;
/*      */     } catch (IOException e) {
...
/* Location:              /home/liuwenhua/tools/LoNg(Official)_ALPS/LoNg_v2.1710.5 (2)/LoNg.jar!/org/apache/log4j/lf5/viewer/LogBrokerMonitor.class
