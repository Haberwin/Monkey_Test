...
/*     */     {
/*     */ 
/* 130 */       pattern = "yyyy-MM-dd HH:mm:ss,SSS"; } else { String pattern;
/* 131 */       if (patternOption.equalsIgnoreCase("ABSOLUTE")) {
/* 132 */         pattern = "HH:mm:ss,SSS"; } else { String pattern;
...
/* Location:              /home/liuwenhua/tools/LoNg(Official)_ALPS/LoNg_v2.1710.5 (2)/LoNg.jar!/org/apache/log4j/pattern/DatePatternConverter.class
