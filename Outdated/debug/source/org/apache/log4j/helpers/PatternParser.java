...
/*     */       DateFormat df;
/* 254 */       DateFormat df; if (dateFormatStr.equalsIgnoreCase("ISO8601"))
/*     */       {
/* 256 */         df = new ISO8601DateFormat(); } else { DateFormat df;
/* 257 */         if (dateFormatStr.equalsIgnoreCase("ABSOLUTE"))
/*     */         {
/* 259 */           df = new AbsoluteTimeDateFormat(); } else { DateFormat df;
...
/* Location:              /home/liuwenhua/tools/LoNg(Official)_ALPS/LoNg_v2.1710.5 (2)/LoNg.jar!/org/apache/log4j/helpers/PatternParser.class
